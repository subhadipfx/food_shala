                ...
                <div class="card-body">
                    <div class="text-uppercase d-flex flex-column text-justify">
                        @if(Auth::user()->isRestaurant())
                            <div><b>Customer Name:</b> {{$current_order->orderedBy->name}}</div>
                            <div><b>Customer Email:</b> {{$current_order->orderedBy->email}}</div>
                            <div><b>Customer Phone:</b> {{$current_order->orderedBy->phoe}}</div>
                            <div><b>Customer Address:</b> {{$current_order->orderedBy->address}}</div>
                        @else
                    ...
                    <hr>
                    <div class="text-center">Items Ordered</div>
