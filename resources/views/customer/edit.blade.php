        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ url('/customer/'.$user->id) }}">
                            @method('put')
                            @csrf
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="email" type="text" class="form-control @error('email') is-invalid @enderror" name="email" value="{{ $user->email }}" required disabled autocomplete="email">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input id="vegetarian" type="radio" class=" @error('vegetarian') is-invalid @enderror" {{$user->vegetarian ? "checked" : null}} name="vegetarian" value="1" required >
                                    <label for="non-vegetarian"> No</label>
                                    <input id="non-vegetarian" type="radio" class=" @error('non-vegetarian') is-invalid @enderror" {{$user->vegetarian ? null : "checked"}} name="vegetarian" value="0" required>
                                    @error('city')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
